    ...
    <div class="join_container">
        ...
        <form method="post" action="${pageContext.request.contextPath}/users/join_action.jsp">
            <div class="joinName joinValue">
                ...
                <input type="text" class="joinInput" id="name_input" placeholder="<%=dto.getUserName()%>"
            ...
            <div class="joinID joinValue">
                ...
                <input type="text" class="joinInput" id="id_input" style="ime-mode: disabled;"
                       placeholder="<%=dto.getUserID()%>" name="userID" title="아이디" maxlength="20" readonly="readonly">

            </div>
            <div class="joinPassword joinValue">
                <label for="pw_input1" class="id_form_title"><b class="point">*</b>비밀번호</label>
                <input type="password" class="joinInput" id="pw_input1" placeholder="<%=dto.getUserPassword()%>"
            ...
            <div class="joinDate joinValue">
                ...
                <input type="date" class="joinInput" id="birth_input" placeholder="<%=dto.getUserDate()%>"
                       name="userDate">
            </div>
