...
<div class="container">
    ...
    <div class="join_container">
        ...
        <form
                method="post"
                onsubmit="check()"
                action="${pageContext.request.contextPath}/users/join_action.jsp"
        >
            ...
            <div class="joinID joinValue">
                <label for="id_input" class="id_form_title"
                ><b class="point">*</b>아이디</label
                >
                <input
                        type="text"
                        class="joinInput"
            ...
            <div class="joinPassword joinValue">
                <label for="pw_input1" class="id_form_title"
                ><b class="point">*</b>비밀번호</label
                >
                <input
                        type="password"
                        class="joinInput"
            ...
            <div class="joinAddr joinValue">
                ...
                <input
                        type="button"
                        onclick="addr_execDaumPostcode()"
                        class="joinInput_addr"
                        value="주소 검색"
                />
                <div
                        id="kakao_map"
            ...
            <div class="joinGender joinValue">
                ...
                <div class="gender_input">
                    <input
                            ...
                            value="M"
                            title="성별"
                    /><label id="rd_gender">남자</label>
                    <input
                            type="radio"
                            name="userGender"
                            value="F"
                            title="성별"
                    /><label id="rd_gender">여자</label>
                </div>
            </div>
