    ...
    <div class="join_container">
        ...
        <form method="post" action="${pageContext.request.contextPath}/users/join_action.jsp">
            <div class="joinName joinValue">
                ...
                <span class="errorMsg_box" id="name_msg" style="display: none" aria-live="assertive"></span>
            </div>
            <div class="joinID joinValue">
                ...
                <div><span class="errorMsg_box" id="id_msg" style="display: none" aria-live="assertive"></span></div>
            </div>
            <div class="joinPassword joinValue">
                ...
                <div><span class="errorMsg_box" id="pw_msg" style="display: none" aria-live="assertive"></span></div>
                <input type="password" class="joinInput" id="pw_input2" placeholder="비밀번호를 입력해주세요." name="userPassword" title="비밀번호" maxlength="40"/>
            </div>
            ...
            <div class="joinPhone joinValue">
                ...
                <span class="errorMsg_box" id="hp_msg" style="display: none" aria-live="assertive"></span>
            </div>
            <div class="joinMail joinValue">
                ...
                <span class="errorMsg_box" id="email_msg" style="display: none" aria-live="assertive"></span>
            </div>
