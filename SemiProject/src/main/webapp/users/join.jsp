	...
	<!-- sub -->
	  ...
	  <p id="join_info">회원 정보</p>
	    <form method="post" action="./join_action.jsp">
	     <div class="joinName joinValue" id="id_form">
	     	 <label id="id_form_title"><b id="point">*</b>이름</label>
	         <input type="text" class="joinInput" id="name_input" placeholder="이름을 입력해주세요."
	          name="userName" title="이름" maxlength="20">
	      </div>
	      <div class="joinID joinValue" id="id_form">
		      <label id="id_form_title"><b id="point">*</b>아이디</label>
	      ...
	      <div class="joinPassword joinValue" id="id_form">
	      	 <label id="id_form_title"><b id="point">*</b>비밀번호</label>
	         <input type="password" class="joinInput" id="pw_input" placeholder="비밀번호를 입력해주세요."
	          name="userPassword" title="비밀번호" maxlength="40">
	      </div>
	      <div class="joinPhone joinValue" id="id_form">
	      	<label id="id_form_title"><b id="point">*</b>전화번호</label>
	        <input type="tel" class="joinInput" id="hp_input" placeholder="휴대폰 번호를 '-' 없이 입력해주세요."
	          name="userPhone" title="전화번호" maxlength="11">
	      </div>
	      <div class="joinMail joinValue" id="id_form">
	     	 <label id="id_form_title"><b id="point">*</b>이메일</label>
	         <input type="email" class="joinInput" id="email_input" placeholder="이메일 주소를 입력해주세요."
	          name="userMail" title="이메일" maxlength="60">
	      </div>
	      <div class="joinAddr joinValue" id="id_form">
	     	 <label id="id_form_title"><b id="point">*</b>주소</label>
	      ...
	      <div class="joinGender joinValue" id="id_form">
	      	<label id="id_form_title"><b id="point">*</b>성별</label>
	      	<div class="gender_input">
		        <input type="radio" name="userGender" value="M" title="성별"><label id="rd_gender">남자</label>
		        <input type="radio" name="userGender" value="F" title="성별"><label id="rd_gender">여자</label>
	        </div>
	      </div>
	      <div class="joinDate joinValue" id="id_form">
	        <label id="id_form_title"><b id="point">*</b>생년월일</label>
